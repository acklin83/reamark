...
class AppSettings(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    accent_color: Mapped[str] = mapped_column(String(7), default="#f0b45f")
    dark_900: Mapped[str] = mapped_column(String(7), default="#14161a")
    dark_800: Mapped[str] = mapped_column(String(7), default="#1b1e24")
    dark_700: Mapped[str] = mapped_column(String(7), default="#22262e")
    dark_600: Mapped[str] = mapped_column(String(7), default="#2b303a")
    text_color: Mapped[str] = mapped_column(String(7), default="#e9ebf0")
    waveform_color: Mapped[str] = mapped_column(String(7), default="#4a515f")
    waveform_progress_color: Mapped[str] = mapped_column(String(7), default="#f0b45f")
    # Light mode colors
    light_accent_color: Mapped[str] = mapped_column(String(7), default="#c98a34")
    ...
    light_waveform_progress_color: Mapped[str] = mapped_column(String(7), default="#c98a34")
